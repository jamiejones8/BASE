...
- `leaderboards/`: legacy calculation references retained for metric-parity
  decisions; this app is not loaded by the BASE runtime.
...
- Delete retired material once it is confirmed unused; Git history is the
  archive for removed source and assets.
